...
def main():
    ...
    parser.add_argument("--primary-limit", type=int, default=1, help="Max items per primary source")
    parser.add_argument("--secondary-limit", type=int, default=1, help="Max items per secondary source")
