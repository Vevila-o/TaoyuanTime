...
class EconomicScraper(BaseScraper):
    def __init__(self, key="economic", name="桃園市政府經濟發展局", start_url="https://edb.tycg.gov.tw/News.aspx?n=3749&sms=9954", fetcher_type="Fetcher"):
        super().__init__(key, name, start_url, fetcher_type)
        self.base_domain = "https://edb.tycg.gov.tw"
